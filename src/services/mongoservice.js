...
const dbName = 'Aufgabe2';


/**
 * @reminder async Funktionen Nachlesen und hier eintragen
 * @returns 
 */



async function readkurse() {
    ...
    try{
        ...
        db = client.db(dbName);
        kurscollection = db.collection('Kurse');
    
        // the following code examples can be pasted here...
        const findResult = await kurscollection.find({}).toArray();
